...
async function fixDatabase() {
  ...
  try {
    ...
    // Drop and recreate the entire database to fix tablespace issues
    await connection.query(`DROP DATABASE IF EXISTS ${process.env.DB_NAME || 'school_forum'}`);
    console.log('🗑️ Dropped existing database');

    await connection.query(`CREATE DATABASE ${process.env.DB_NAME || 'school_forum'} CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci`);
    ...
    console.log('\n🎉 Database fixed and setup completed!');
    console.log('\n🔑 Demo Accounts:');
